...
<body>
    <section>
    <div class="room-info">
        <h3>✦ Chambres Classiques ✦</h3>
        
        
        
        <div id="slideshow-container">
            <div class="slide">
                <img src="imagee1.jpg" alt="Imagee 1">
            </div>
            
            <div class="slide">
                <img  src="imagee2.jpg" alt="Imagee 2">
            </div>
            
            
            <div class="slide">
                <img src="imagee3.jpg" alt="Imagee 3">
            </div>
        ...
        <ul>
            ...
            <p class="room-feature"><strong>Taille: </strong> 28 m²</p>
            <p class="room-feature"><strong>Max: </strong> 1 personne</p>
            <p class="room-feature"><strong>Prix: à partir de </strong> 264,60 € | Nuit</p>
