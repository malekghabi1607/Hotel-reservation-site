...
$titre = "Premium Room"; ?>
<title>Premium sea pool view Room</title>
</header>
<head>
...
<body>
    <section>
    <div class="room-info">
        <h3>✦ Chambre Premium avec vue sur la mer/piscine ✦</h3>
        
        <div id="slideshow-container">
            <div class="slide">
                <img src="imagee1111.jpg" alt="Imagee 11">
            </div>
            
            <div class="slide">
                <img src="imagee1222.jpg" alt="Imagee 21">
            </div>
            
            
            <div class="slide">
                <img src="imagee1333.jpg" alt="Imagee 31">
            </div>
        ...
        <p1>Les chambres Premium avec vue sur la mer/la piscine du  Maleke Palace varient en taille de 42 à 48 mètres carrés et sont situées dans le bâtiment principal de l'hôtel. Ils peuvent accueillir jusqu'à trois adultes et disposent d'un canapé et d'un balcon avec vue sur la piscine principale, choisissez entre un grand lit et deux plus petits lits séparés. Ces chambres disposent également d'une salle de bains avec baignoire ou douche et de produits de bain haut de gamme. Les équipements supplémentaires de la chambre comprennent un bureau, une télévision à écran LED, un minibar et un coffre-fort. Deux de nos chambres Premium sont accessibles aux personnes à mobilité réduite.</p1>
        ...
        <ul>
            ...
            <p class="room-feature"><strong>Taille: </strong> 48 m²</p>
            <p class="room-feature"><strong>Max: </strong> 3 personne </p>
            <p class="room-feature"><strong>Prix: à partir de </strong> 394,00 € | Nuit</p>
